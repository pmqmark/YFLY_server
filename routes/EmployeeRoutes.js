...
const employeeNotifyCtrl = require("../controllers/EmployeeNotificationController");
...
router.put(
  "/deactivate/:id",
  adminCheckMiddleware,
  employeeCtrl.DeactivateEmployee
);

router.get(
  "/get-assigned-works/:id",
  employeeChecker,
  employeeCtrl.RetrieveWorks
);

router.get(
  "/get-task-metrics/:id",
  employeeChecker,
  employeeCtrl.GetEmployeeTaskMetrics
);

router.get(
  "/get-assigned-projects/:id",
  employeeChecker,
  employeeCtrl.GetMyProjectTasks
);
...
router.post(
  "/notification/create-exam",
  employeeChecker,
  employeeNotifyCtrl.createExamNotification
);
